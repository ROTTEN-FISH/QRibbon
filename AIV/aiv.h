...
public:
    ...
    Mat static QImage2cvMat(QImage &image, bool clone = true, bool rb_swap = false);
    QImage static cvMat2QImage(const cv::Mat& mat, bool clone = true, bool rb_swap = true);
