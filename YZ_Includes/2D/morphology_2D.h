...
namespace YZVision
{
	...
	public:
		...
		*/
        ...
        uint32_t static Expansion(InputParam inputParam, OutputParam *outputParam);
        uint32_t static Corrosion(InputParam inputParam, OutputParam *outputParam);
