...
namespace YZVision
{
	class CloudDeduplication_3D
	{
	public: CloudDeduplication_3D();
		  ~CloudDeduplication_3D();
		  ...
		  /*
			  ...
			  */
		  uint32_t clouddeduplication(InputParam inputParam, OutputParam* outputParam);

	private:
		uint32_t CloudDeduplication(c_vPointsXYZ* inputcloud, int a, float l_0, float l_1, vPointsXYZ* outputcloud);
