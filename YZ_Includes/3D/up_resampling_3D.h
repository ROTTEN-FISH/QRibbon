...
namespace YZVision
{
	class Upresampling_3D
	{
	public: Upresampling_3D();
		  ~Upresampling_3D();
		  ...
		  /*
			  ...
			  */
		  uint32_t upresampling(InputParam inputParam, OutputParam* outputParam);

	private:
		uint32_t UpResampling(c_vPointsXYZ* inputcloud, float r_0,float r_1,float s_0, vPointsXYZ* outputcloud);
