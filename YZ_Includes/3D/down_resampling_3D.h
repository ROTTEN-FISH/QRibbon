...
namespace YZVision
{
	class Downresampling_3D
	{
	public: Downresampling_3D();
		  ~Downresampling_3D();
		  ...
		  /*
			  ...
			  */
		  uint32_t downresampling(InputParam inputParam, OutputParam* outputParam);

	private:
		uint32_t DownResampling(c_vPointsXYZ* inputcloud, float r_0, vPointsXYZ* outputcloud);
